...
const Orders = () => {
  ...
  return (
    ...
    <div className=' font-livvic min-h-[100vh] lg:px-[8vw] md:pt-20 pt-28 px-6 bg-red'>
      <div className='flex flex-col gap-8 mt-10 max-lg:mt-28'>


        <h2 className='font-semibold text-xl'>My Orders</h2>

        <div className="relative overflow-x-auto  mb-8 border border-gray-300">
          <table className="w-full text-sm text-left bg-gray-100 ">
            <thead className="text-xs text-gray-900 uppercase p-10  rounded-lg border-b border-gray-300 bg-gray-300 ">
              <tr>
            ...
            <tbody>
              ...
              {orders.map((item) => {
                ...
                return (
                  <tr key={item._id} className=" border-b border-gray-300 rounded-lg text-gray-800 font-medium  ">
