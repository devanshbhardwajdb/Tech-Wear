...
const Checkout = ({ cart, clearCart, subTotal, user }) => {
    ...
    if (phone.length !== 10) {
      ...
      if (data.success) {
        ...
        const options = {
          ...
          image: `${process.env.NEXT_PUBLIC_HOST}/_next/static/media/logo1.f366ce4d.png`,

          prefill: {
            name: userData?.name || "Tech Wear",
    ...
    <>
      ...
      <div className='text-gray-600 font-livvic min-h-[100vh] lg:px-[8vw] pt-[20vh] px-6 mb-60'>
        ...
        <div className="flex  flex-col gap-5 lg:w-1/2 mt-10">
          ...
          {userData &&
            <div className='bg-gray-300 p-8 flex flex-col gap-5 rounded-xl'>
          ...
          <div className="sidecart flex flex-col   " >
            ...
            <div className='flex justify-start mt-8 gap-6 flex-col'>
              ...
              <button
                ...
                className='disabled:bg-gray-400  nav-btn  bg-[#56E0DD] text-white px-5 py-2 rounded-lg  transition-all duration-150  hover:scale-95  hover:shadow-lg hover:shadow-gray-300 md:w-1/4 ' >Pay ₹ {subTotal}
              </button>
