  ...
  return (
    <>
      <nav id="navbar" className='navbar flex  bg-white shadow-lg shadow-gray-200  justify-between max-lg:flex-col gap-3  font-livvic px-[8vw] py-[2vh] items-center text-base font-medium text-gray-600 fixed w-full  mb-64 z-20  '>
        ...
        <div className="logo flex items-center lg:gap-0  max-lg:flex-col gap-4 h-full">
          {/* <HiOutlineMenuAlt1/> */}
            ...
            <div className='lg:relative '>
              ...
              {dropdown &&
                ...
                <div
                  ...
                  className="dropdown bg-gray-100 absolute right-0 max-lg:left-0  px-10  pt-6 pb-4 rounded-lg lg:rounded-tr-none gap-5 flex flex-col shadow-lg shadow-gray-400   "
                >
        ...
        <div ref={ref} className={`sidecart fixed overflow-y-auto   top-0  w-[100vw] lg:w-[30vw] md:w-[60vw] h-full right-0 bg-gray-100 pb-36 shadow-lg shadow-gray-400 flex flex-col gap-4 p-5 transform transition-transform max-md:border-t max-md:border-gray-300  ${(Object.keys(cart).length === 0 || !sidebar) ? `translate-x-full` : `translate-x-0 `} `}  >
